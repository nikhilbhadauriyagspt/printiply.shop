  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <p className="text-[10px] font-bold capitalize tracking-[0.5em] text-slate-300">Retrieving Specs</p>
      </div>
    );
  }
  ...
  if (!product) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-center px-6">
        <h2 className="text-4xl font-bold text-slate-900 capitalize mb-4">Product Not Found</h2>
        <Link to="/shop" className="px-10 py-4 bg-black text-white rounded-full text-[10px] font-bold capitalize tracking-[0.2em]">Return to Shop</Link>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-20 font-urbanist">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        {/* Breadcrumbs */}
        <nav className="flex items-center gap-2 text-[10px] font-bold capitalize tracking-widest text-slate-400 mb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24">
          ...
          <div className="flex flex-col">
            <div className="mb-8">
              <span className="inline-block px-4 py-1.5 bg-blue-600 text-white text-[9px] font-bold capitalize tracking-[0.2em] rounded-full mb-6">
                {product.brand_name || 'Premium Listing'}
              </span>
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-[1.1]  capitalize mb-6">
                {product.name}
              </h1>

              <div className="flex items-center gap-6 mb-8">
                <span className="text-[10px] font-bold capitalize tracking-widest text-green-600 flex items-center gap-1.5">
            ...
            <div className="space-y-6 mt-auto">
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  ...
                  disabled={isAdded}
                  className={`flex-grow h-16 rounded-2xl flex items-center justify-center gap-3 text-xs font-bold capitalize tracking-[0.2em] transition-all shadow-2xl active:scale-[0.98] ${isAdded ? 'bg-emerald-500 text-white' : 'bg-blue-600 text-white hover:bg-slate-900 shadow-blue-600/20'}`}
                >
                  {isAdded ? (
              ...
              <div className="grid grid-cols-3 gap-4 pt-8 border-t border-gray-100">
                <div className="flex flex-col items-center text-center gap-3">
                  ...
                  <span className="text-[9px] font-bold capitalize tracking-widest text-slate-400">Express Delivery</span>
                </div>
                <div className="flex flex-col items-center text-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-900">
                    <ShieldCheck size={18} />
                  </div>
                  <span className="text-[9px] font-bold capitalize tracking-widest text-slate-400">Official Warranty</span>
                </div>
                <div className="flex flex-col items-center text-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-900">
                    <RefreshCcw size={18} />
                  </div>
                  <span className="text-[9px] font-bold capitalize tracking-widest text-slate-400">7-Day Returns</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-32 border-t border-gray-100 pt-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
              <div className="space-y-2">
                <h2 className="text-[10px] font-bold text-blue-600 capitalize tracking-[0.4em]">Personalized for you</h2>
                <h3 className="text-4xl font-bold text-slate-900  capitalize">Related <span className="text-slate-300">Discoveries.</span></h3>
              </div>
              <Link to="/shop" className="text-[10px] font-bold capitalize tracking-widest text-slate-400 hover:text-blue-600 transition-colors flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
              {relatedProducts.map((p) => (
                ...
                >
                  ...
                  <div className="px-1">
                    <p className="text-[8px] font-bold text-blue-600 capitalize tracking-widest mb-1">{p.brand_name}</p>
                    <h4 className="text-[11px] font-bold text-slate-800 group-hover:text-blue-600 transition-colors capitalize  line-clamp-1 mb-2">{p.name}</h4>
